...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self._parser.add_argument('--wb_entity', type=str, default='rifaath-ameen-fau-erlangen-n-rnberg', help='Wandb entity name')
        self._parser.add_argument('--wb_project', type=str, default='Glyph', help='Wandb project')
