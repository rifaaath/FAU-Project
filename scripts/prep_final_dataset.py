...
full_manifest_path = "pipeline_output/5_final_manifest.csv"
json_path = "papytwin/HomerCompTraining/HomerCompTraining.json"
output_dir = Path("pipeline_output/6_final_splits")
...
def get_base_char_name(char_str):
    ...
    # Handle other symbols if necessary, for now return None
    return None
